...
public class ListClassAdapter extends RecyclerView.Adapter<ListClassAdapter.ViewHolder> {

    private List<GetSetClass> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public ListClassAdapter(Context context, List<GetSetClass> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_list_class, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        GetSetClass data = mData.get(position);
        Url url = new Url();
        ...
        holder.address_class.setText(data.getEmail());
    ...
    public GetSetClass getItem(int id) {
        return mData.get(id);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView name_class, area_class, degree_class,
                clash_class, address_class, tel_class, etc_class, name_tutor_user, last_name_tutor_user;
        ImageView img;
