...
public class SeeRatting extends AppCompatActivity implements ListRattingAdapter.ItemClickListener {
    ...
    public void loadData() {
        requestQueue = Volley.newRequestQueue(getApplicationContext());
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url.list_tutor_ratting, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    JSONArray jsonArray = jsonObject.getJSONArray("list_ratting");
            ...
            public void onErrorResponse(VolleyError error) {
                Intent intent = new Intent(SeeRatting.this, NoInternet.class);
                startActivity(intent);
                Toast.makeText(SeeRatting.this, "Net Work Problem " + error.toString(), Toast.LENGTH_SHORT).show();
